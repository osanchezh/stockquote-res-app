...
--
-- Host: localhost    Database: financialexchangedb
-- ------------------------------------------------------
...
CREATE TABLE `fx_company` (
  `idcompany` int(5) NOT NULL AUTO_INCREMENT,
  `idindustry` int(5) NOT NULL,
  `name` varchar(100) NOT NULL,
  `marketcap` varchar(5) DEFAULT NULL,
  ...
  CONSTRAINT `idindustry` FOREIGN KEY (`idindustry`) REFERENCES `fx_industry` (`idindustry`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `fx_industry` (
  `idindustry` int(5) NOT NULL AUTO_INCREMENT,
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `financialexchangedb`.`fx_industry_BEFORE_UPDATE` BEFORE UPDATE ON `fx_industry` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `financialexchangedb`.`fx_sector_BEFORE_UPDATE` BEFORE UPDATE ON `fx_sector` FOR EACH ROW
BEGIN
 set new.lastupdate=now();
END */;;
DELIMITER ;
...
-- Dump completed on 2017-05-31 19:57:49
